...
public:
    ...
    void init() override {
        ...
        createInternalTriggerParameter("vibratoDepth", 0.1, 0.0, 5.0);
        createInternalTriggerParameter("vibratoRate", 0.1, 0.0, 10.0);
    ...
    virtual void onProcess(AudioIOData& io) override {
        ...
        while(io()){
            float vibratoDepth = getInternalParameter("vibratoDepth");
            mOsc.freq(getInternalParameterValue("frequency") + vibratoDepth * mVibrato()); //larger bw, larger effect from vibrato
...
//        mBWEnv.triggerRelease();
    ...
    //    mAmpEnv.decay(getInternalParameterValue("attackTime"));
        ...
        mVibrato.freq(getInternalParameter("vibratoRate")); 
    }
};
